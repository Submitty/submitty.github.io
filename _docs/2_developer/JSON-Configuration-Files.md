...
```
{
    ...
    "instructions_url": "https://github.com/Submitty/Submitty/tree/master/sample_files/sample_submissions/cpp_custom",
    "date_due": "08/07/2016 23:59:59",
    "eg_late_days": 2,
    "upload_type": "Upload File",
    "config_path": "/usr/local/submitty/sample_files/sample_assignment_config/cpp_custom/config.json",
    "point_precision": 0.5,
    "ta_grading": true,
    "comment_title": [
