...
option. Using Github, `git clone
git@github.com:myusername/student101.git`.

4. Set the upstream repository using `git remote add upstream
SSH_URL`. Replace `SSH_URL` with the 'Clone with SSH' URL from the
