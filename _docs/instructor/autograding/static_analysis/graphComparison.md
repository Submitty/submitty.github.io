...
0. Ensure that you have compeleted the additional installation steps for the [tree visualization tool](/instructor/autograding/static_analysis/tree_tool "Tree Visualization Documentation")
1. Create JSON output of the full AST
   * If the file is a python file, "filename.py" use the [Diagnostics](/instructor/autograding/static_analysis) tool. 
   * If the file is a C++ file, "filename.cpp" use the [C++ Union Tool](/instructor/autograding/static_analysis/cppUnionTool)
