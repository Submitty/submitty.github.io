...
Worked with Submitty on Discussion Forum under Google Summer of Code 2018. *Barbara Cutler*, *Master_Odin* and *Andrew Aikens* were officially assigned mentors who along with other Submitty members helped me at various stages at design problems, code review and performance issues which made this journey easier for me.
...
This project helped to inculcate a spirit of teamwork in me and also instilled the coordination, cooperation required to work in a team. I absorbed the importance of code reviews/feedbacks by others as they might have a completely different angle to view the problem.
...
- Paging on Thread List
  ...
  - Forum: Bidirectional scroll for thread list ([#2654](https://github.com/Submitty/Submitty/pull/2654)) __[Open PR]__

  - Forum Thread paging ([#2473](https://github.com/Submitty/Submitty/pull/2473))
  Forum page has thread list in the left column. However, as the semester grows, the number of threads can dramatically increase the page loading time. Introducing paging in thread list not only decreases the page loading time by not fetching the whole thread list again but it also enhances user experience by loading limited threads in a view at a time .
...
- Forum Thread Status ([#2341](https://github.com/Submitty/Submitty/pull/2341))
...
- Posts/Threads related
  ...
  - Forum show deleted threads ([#2151](https://github.com/Submitty/Submitty/pull/2151))
  ...
  - Forum: Undelete posts/thread  ([#2248](https://github.com/Submitty/Submitty/pull/2248))
  ...
  - Forum Multiple Attachments ([#2242](https://github.com/Submitty/Submitty/pull/2242))
  ...
  - Forum Edit Thread ([#2150](https://github.com/Submitty/Submitty/pull/2150))
...
- Thread Categories
  - Forum allow multiple categories for a thread ([#2083](https://github.com/Submitty/Submitty/pull/2083))
    Earlier, an instructor was allowed to add a new type of category to the categories list. And all the threads are assigned one category of relevance.
    Now each thread is allowed to have more than one category and anyone can filter thread based on a set of categories.

  - Forum Edit Categories (Reordering) ([#2126](https://github.com/Submitty/Submitty/pull/2126))

  - Forum Categories having colors and edit category features ([#2135](https://github.com/Submitty/Submitty/pull/2135))
