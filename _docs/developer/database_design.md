...
## Entity-Relation Diagrams
   ...
   1. Submitty Database (updated June 5, 2019, see [code for most recent](https://github.com/Submitty/Submitty/blob/master/site/data/submitty_db.sql)):
      ![Database Entity Graph](/images/database_entity_graph.png)

   2. Courses Tables (updated June 5, 2019, see [code for most recent](https://github.com/Submitty/Submitty/blob/master/site/data/course_tables.sql)):
